...
Para resolver el problema, se implementaron los algoritmos de ordenamiento Bubble Sort optimizado, Insertion Sort, Selection Sort optimizado mediante búsqueda simultánea de mínimo y máximo, y Cocktail Shaker Sort, junto con búsqueda secuencial y búsqueda binaria iterativa. A partir de estas implementaciones, también se realizaron pruebas experimentales para comparar sus tiempos de ejecución en distintos tamaños de entrada.
