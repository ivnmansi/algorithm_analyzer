...
Una vez cargados los datos de los deportistas, el programa permite realizar distintas operaciones sobre ellos por medio de parametros de línea de comandos. Entre las funcionalidades principales se encuentra el ordenamiento de los datos de los deportistas de manera ascendente o descendente utilizando el ID, puntaje, cantidad de competencias, nombre y equipo. Para ello, el usuario puede seleccionar alguno de los algoritmos de ordenamiento implementados en el programa.
...
\subsection{Bubble Sort optimizado}
